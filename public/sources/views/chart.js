...
import {create, locate, offset as getOffset, pos as getPos} from "../webix/html";
...
const api = {
    ...
    _rainbow: [
        function (pos) {
            return "#FF" + color.toHex(pos / 2, 2) + "00";
        },
        function (pos) {
            return "#FF" + color.toHex(pos / 2 + 128, 2) + "00";
        },
        function (pos) {
            return "#" + color.toHex(255 - pos, 2) + "FF00";
        },
        function (pos) {
            return "#00FF" + color.toHex(pos, 2);
        },
        function (pos) {
            return "#00" + color.toHex(255 - pos, 2) + "FF";
        },
        function (pos) {
            return "#" + color.toHex(pos, 2) + "00FF";
        }
    ],
    _defColors: [
    ...
    _get_tooltip_data: function (t, e) {
        ...
        let def = extend({
            ...
            template: "{obj.value}",
            css: ""
        }, (this._series[active].tooltip || {template: ""}), true);
