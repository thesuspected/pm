import {assert, debug_size_box_end, debug_size_box_start} from "../webix/debug";

import {callEvent} from "../webix/customevents";
import {insertBefore, remove} from "../webix/html";
import {_power_array, copy, extend, isUndefined} from "../webix/helpers";
    ...
    _set_child_size: function (x, y) {
        ...
        for (let i = 0; i < this._cells.length; i++) {
            ...
            if (this._vertical_orientation) {
                ...
                if (height < 0) {
                    auto.push({oldIndex: i, view: this._cells[i]});
                    continue;
                }
            } else {
