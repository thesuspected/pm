...
import {_getClassName, addStyle, create, createCss, getTextSize, index as getIndex, remove} from "../webix/html";
import {$$, protoUI, ui} from "../ui/core";
import {$active} from "../webix/skin";
import {bind, clone, delay, extend, isUndefined, toFunctor, uid} from "../webix/helpers";
import {assert, debug_size_box} from "../webix/debug";
            ...
            for (var i = 0; i < this._columns.length; i++) {
                ...
                if (col.numberFormat) {
                    ...
                    col.editFormat = col.editFormat || function (val) {
                        return Number.format(val, nformat);
                    };
                    col.editParse = col.editParse || function (val) {
                        return Number.parse(val, nformat);
                    };
                }
